...
#THIS SCRIPT IS AN EDIT FROM LEROBOT(https://github.com/huggingface/lerobot) RECORDING FUNCTION
...
def add_data_to_observation(observation) -> dict[str, Any]:
        sensor_data_value = 1. #TODO : recolter la vrai donnée 
        sensor_data = np.array(sensor_data_value, dtype=np.float32)  
        observation.update({"sensor.value": sensor_data})
        return observation
...
def record_loop(
    ...
    while timestamp < control_time_s:
        ...
        observation = add_data_to_observation(observation) #function implementation
...
def record(cfg: RecordConfig) -> LeRobotDataset:
    ...
    obs_features.update(sensor_feature)
